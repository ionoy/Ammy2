...
namespace Clarity.VisualStudio.Generation
{
    class MetaGenerator
    {
        public ClarityPageGenerator ClarityPage { get; } = new ClarityPageGenerator();
        ...
        public string Generate()
        {
            ...
            builder.AppendLine("namespace Clarity {");
            
            builder.AppendLine(
@"
  public abstract partial class ClarityPage : Xamarin.Forms.ContentPage, System.IDisposable
  {
