        ...
        private void GenerateEventExtensions(StringBuilder sb)
        {
            foreach (var (returnType, parms, eventType, eventName) in EventExtensions) {
                ...
                if (IsSealed || _extensionsGenerator.HasCollisions(eventName)) {
                    ...
                    var signature1 = $"this {TypeFullName} obj, System.{systemDelegateName}<{parameters}> handler, ClarityPage page";
                    ...
                    var signature1 = $"this TElement obj, System.{systemDelegateName}<{parameters}> handler, ClarityPage page";
